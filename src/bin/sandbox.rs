...
fn main() {
    ...
    let inputs:Vec<(&str, RangeInclusive<usize>, fn(usize) ->String)> = vec![
        ...
        ("Random4-c", 0..=15, |x| format!("ch9-1.1/inputs/Random4-c/Random4-c.{}.0.gr", x)),
        ...
        ("Long-C", 0..=10, |x| format!("ch9-1.1/inputs/Long-C/Long-C.{}.0.gr", x)),
        ("Square-C", 0..=13, |x| format!("ch9-1.1/inputs/Square-C/Square-C.{}.0.gr", x)),
